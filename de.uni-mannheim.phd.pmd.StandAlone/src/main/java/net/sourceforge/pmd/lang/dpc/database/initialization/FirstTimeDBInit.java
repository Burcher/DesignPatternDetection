package net.sourceforge.pmd.lang.dpc.database.initialization;
...
public class FirstTimeDBInit {
	...
	public FirstTimeDBInit(Connection dbconn) {
		...
		this.createAttributeTable("attributes");
		this.createAttributeTable("attributesForConnections");
	...
	private void createAttributeTable(String tableName) {
		try {
			initStatement = this.connection.createStatement();
