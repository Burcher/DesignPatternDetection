    ...
    private static void sortFiles(final PMDConfiguration configuration, final List<DataSource> files) {
        if (configuration.isStressTest()) {
            ...
            Collections.sort(files, new Comparator<DataSource>() {
				...
				public Comparator<DataSource> reversed() {
					// TODO Auto-generated method stub
					return null;
				}

				public Comparator<DataSource> thenComparing(
						Comparator<? super DataSource> arg0) {
					// TODO Auto-generated method stub
					return null;
				}

				public <U extends Comparable<? super U>> Comparator<DataSource> thenComparing(
						Function<? super DataSource, ? extends U> arg0) {
					// TODO Auto-generated method stub
					return null;
				}

				public <U> Comparator<DataSource> thenComparing(
						Function<? super DataSource, ? extends U> arg0,
						Comparator<? super U> arg1) {
					// TODO Auto-generated method stub
					return null;
				...
				public Comparator<DataSource> thenComparingDouble(
						ToDoubleFunction<? super DataSource> arg0) {
					// TODO Auto-generated method stub
					return null;
				}

				public Comparator<DataSource> thenComparingInt(
						ToIntFunction<? super DataSource> arg0) {
					// TODO Auto-generated method stub
					return null;
				}

				public Comparator<DataSource> thenComparingLong(
						ToLongFunction<? super DataSource> arg0) {
					// TODO Auto-generated method stub
					return null;
				}
            });
