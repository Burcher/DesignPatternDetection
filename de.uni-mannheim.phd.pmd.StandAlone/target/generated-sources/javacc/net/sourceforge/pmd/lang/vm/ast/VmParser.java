/* Generated By:JJTree&JavaCC: Do not edit this line. VmParser.java */
 ...
 * @version $Id$
*/
public class VmParser/*@bgen(jjtree)*/implements VmParserTreeConstants, VmParserConstants {/*@bgen(jjtree)*/
  protected JJTVmParserState jjtree = new JJTVmParserState();/**
 ...
 */
  final public ASTprocess process() throws ParseException {
                        /*@bgen(jjtree) process */
 ...
 */
  final public int DirectiveArg() throws ParseException {
    ...
    case LCURLY:
      Reference();
        {if (true) return VmParserTreeConstants.JJTREFERENCE;}
      break;
    case WORD:
      Word();
        {if (true) return VmParserTreeConstants.JJTWORD;}
      break;
    case STRING_LITERAL:
      StringLiteral();
        {if (true) return VmParserTreeConstants.JJTSTRINGLITERAL;}
      break;
    case INTEGER_LITERAL:
      IntegerLiteral();
        {if (true) return VmParserTreeConstants.JJTINTEGERLITERAL;}
      break;
    default:
      jj_la1[5] = jj_gen;
      if (jj_2_3(2147483647)) {
        IntegerRange();
        {if (true) return VmParserTreeConstants.JJTINTEGERRANGE;}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case FLOATING_POINT_LITERAL:
          FloatingPointLiteral();
        {if (true) return VmParserTreeConstants.JJTFLOATINGPOINTLITERAL;}
          break;
        case LEFT_CURLEY:
          Map();
        {if (true) return VmParserTreeConstants.JJTMAP;}
          break;
        case LBRACKET:
          ObjectArray();
        {if (true) return VmParserTreeConstants.JJTOBJECTARRAY;}
          break;
        case TRUE:
          True();
        {if (true) return VmParserTreeConstants.JJTTRUE;}
          break;
        case FALSE:
          False();
        {if (true) return VmParserTreeConstants.JJTFALSE;}
          break;
        default:
          jj_la1[6] = jj_gen;
          jj_consume_token(-1);
 ...
 *     #foo( arg+ )
 */
  final public VmNode Directive() throws ParseException {
    ...
    try {
      ...
      jjtc000 = false;
        ...
        if (doItNow)
        {
            ...
            // on defined macros
            String macroName = ((AbstractVmNode)jjtn000.jjtGetChild(0)).getFirstToken().image;
 ...
 * ----------------------------------------------------------------------*/
  ...
  public VmParser(CharStream stream) {
    token_source = new VmParserTokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
